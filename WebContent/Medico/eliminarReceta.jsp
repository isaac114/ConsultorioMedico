		...
		<div class="row">
			...
			<div class=col-xs-3>
				...
				<div class="dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						<a style="font-size: 15px" class="dropdown-item"
							href="http://localhost:8080/ConsultorioMedico/">Agregar
			...
			<div class=col-xs-4>
				<div></div>
				<div>
					<h2 style="color: white; font-size: 25px">Eliminar Orden</h2>
				</div>
				...
				<form method="post"
					...
					<div class="form-group">
						...
						<input style="font-size: 18px" type="text" class="form-control"
							id="CIpaciente" name="CIpaciente" placeholder="Ingrese C.I">
					</div>

					<button style="font-size: 18px" type="Eliminar"
